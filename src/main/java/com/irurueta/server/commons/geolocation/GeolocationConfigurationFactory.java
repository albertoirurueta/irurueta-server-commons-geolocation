...
public class GeolocationConfigurationFactory extends
     ...
     */
    public static synchronized GeolocationConfigurationFactory getInstance() {
        if (mSingleton == null) {
            mSingleton = new GeolocationConfigurationFactory();
        }
        return mSingleton;
    }
     ...
     */
    @Override
    public synchronized BaseConfigurationFactory<GeolocationConfiguration> reset()
            throws ConfigurationException {
        try {
            IPGeolocator.reset();
